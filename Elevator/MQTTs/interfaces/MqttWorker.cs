...
namespace Elevator1.MQTTs.interfaces
{
    public class MqttWorker : IMqttWorker
    {
        ...
        public MqttWorker()
        {
            ...
            List<MqttTopicSubscribe> SubscribeTopics = ConfigData.SubscribeTopics;
            ...
            _mqttClient.ConnectedAsync += async e =>
            {
                ...
                {
                    _logger.Info("구독할 Topic이 없습니다. MQTT Subscribe를 건너뜁니다.");
                }
                else
                {
                    foreach (var subscribe in SubscribeTopics)
                    {
